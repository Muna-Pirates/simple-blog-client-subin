...
export type ListPostsQuery = { __typename?: 'Query', listPosts: { __typename?: 'PostPaginationResult', posts: Array<{ __typename?: 'Post', id: string, title: string, content: string, createdAt: any, author: { __typename?: 'User', id: number, name?: string | null, email: string }, comments: Array<{ __typename?: 'Comment', id: string }>, category?: { __typename?: 'Category', id: string, name: string } | null }> } };
