...
export type CommentItemFragment = { __typename?: 'Comment', id: string, content: string, createdAt: any, author: { __typename?: 'User', id: number, name?: string | null, email: string } } & { ' $fragmentName'?: 'CommentItemFragment' };
...
export type ListPostsQuery = { __typename?: 'Query', listPosts: { __typename?: 'PostPaginationResult', pagination: { __typename?: 'PaginationInfo', page: number, pageSize: number, totalItems: number }, posts: Array<{ __typename?: 'Post', id: string, title: string, content: string, createdAt: any, author: { __typename?: 'User', id: number, name?: string | null, email: string }, comments: Array<{ __typename?: 'Comment', id: string }> }> } };
...
export type ViewPostQuery = { __typename?: 'Query', viewPost: { __typename?: 'Post', id: string, title: string, content: string, createdAt: any, author: { __typename?: 'User', id: number, name?: string | null, email: string }, comments: Array<(
      { __typename?: 'Comment' }
...
export type SearchPostsQuery = { __typename?: 'Query', searchPosts: { __typename?: 'PostPaginationResult', pagination: { __typename?: 'PaginationInfo', page: number, pageSize: number, totalItems: number }, posts: Array<{ __typename?: 'Post', id: string, title: string, content: string, createdAt: any, author: { __typename?: 'User', id: number, name?: string | null, email: string }, comments: Array<{ __typename?: 'Comment', id: string }>, category?: { __typename?: 'Category', name: string } | null }> } };
...
export type ListCommentsQuery = { __typename?: 'Query', viewPost: { __typename?: 'Post', comments: Array<(
      { __typename?: 'Comment' }
      & { ' $fragmentRefs'?: { 'CommentItemFragment': CommentItemFragment } }
    )> } };
...
export type OnCommentAddedSubscription = { __typename?: 'Subscription', onCommentAdded: (
    { __typename?: 'Comment' }
    & { ' $fragmentRefs'?: { 'CommentItemFragment': CommentItemFragment } }
  ) };
...
export const SearchPostsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SearchPosts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"searchCriteria"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PostSearchInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pagination"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PaginationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"searchPosts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"searchCriteria"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchCriteria"}}},{"kind":"Argument","name":{"kind":"Name","value":"pagination"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pagination"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pagination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"page"}},{"kind":"Field","name":{"kind":"Name","value":"pageSize"}},{"kind":"Field","name":{"kind":"Name","value":"totalItems"}}]}},{"kind":"Field","name":{"kind":"Name","value":"posts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}},{"kind":"Field","name":{"kind":"Name","value":"comments"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"category"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}}]}}]} as unknown as DocumentNode<SearchPostsQuery, SearchPostsQueryVariables>;
