...
} & { " $fragmentName"?: "CommentItemFragment" };
...
export type OnCommentAddedSubscription = {
  __typename?: "Subscription";
  onCommentAdded: { __typename?: "Comment" } & {
    " $fragmentRefs"?: { CommentItemFragment: CommentItemFragment };
  };
};
...
export type FindCategoryByNameQuery = {
  __typename?: "Query";
  findCategoryByName?: { __typename?: "Category"; id: string } | null;
};

export type ViewUserProfileQueryVariables = Exact<{ [key: string]: never }>;

export type ViewUserProfileQuery = {
  __typename?: "Query";
  viewUserProfile?: {
    __typename?: "User";
    id: number;
...
export type DeleteUserMutation = {
  __typename?: "Mutation";
  deleteUser: { __typename?: "User"; email: string };
};
...
} as unknown as DocumentNode<CommentItemFragment, unknown>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "PostSearchInput" },
            },
          },
        },
        {
...
>;
export const AssignCategoryToPostDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AssignCategoryToPost" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  AssignCategoryToPostMutation,
  AssignCategoryToPostMutationVariables
>;
export const FindCategoryByNameDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FindCategoryByName" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  FindCategoryByNameQueryVariables
>;
export const ViewUserProfileDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ViewUserProfile" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
